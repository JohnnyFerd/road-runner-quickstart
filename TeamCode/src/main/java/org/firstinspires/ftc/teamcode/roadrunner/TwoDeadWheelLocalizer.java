...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1008.03; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 4468.55445; // x position of the perpendicular encoder (in tick units)
    }
